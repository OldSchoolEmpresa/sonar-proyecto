...
@Component({
  selector: 'app-ventas-beisbolera',
  templateUrl: './ventas-beisbolera.component.html',
  styleUrls: ['./ventas-beisbolera.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasBeisboleraComponent {
