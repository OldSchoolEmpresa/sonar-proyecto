...
@Component({
  selector: 'app-ventas-betsport',
  templateUrl: './ventas-betsport.component.html',
  styleUrls: ['./ventas-betsport.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasBetsportComponent {
    ...
    this.http.post(url, pedidoParaEnviar).subscribe({
      next: (response: any) => {
        ...
        const pedidoParaDetalle = {
          ...
          cliente: {
            nombre: this.pedido.usuario.nombre,
            documento: '', // si lo tienes en tu formulario puedes llenarlo
            direccion: this.pedido.usuario.direccion,
            telefono: this.pedido.usuario.telefono,
            email: this.pedido.usuario.email
          },
