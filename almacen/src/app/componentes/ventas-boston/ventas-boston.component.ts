...
@Component({
  selector: 'app-ventas-boston',
  templateUrl: './ventas-boston.component.html',
  styleUrls: ['./ventas-boston.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasBostonComponent {
    ...
    this.http.post(url, pedidoParaEnviar).subscribe({
      next: (response: any) => {
        const pedidoParaDetalle = {
          ...
          cliente: { ...this.pedido.usuario, documento: '' },
          productos: [{
