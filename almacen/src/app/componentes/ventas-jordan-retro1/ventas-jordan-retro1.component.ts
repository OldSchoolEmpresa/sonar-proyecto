...
@Component({
  selector: 'app-ventas-jordan-retro1',
  templateUrl: './ventas-jordan-retro1.component.html',
  styleUrls: ['./ventas-jordan-retro1.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasJordanRetro1Component {
