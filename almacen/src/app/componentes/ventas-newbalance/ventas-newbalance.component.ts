...
@Component({
  selector: 'app-ventas-newbalance',
  templateUrl: './ventas-newbalance.component.html',
  styleUrls: ['./ventas-newbalance.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasNewBalanceComponent {
