...
@Component({
  selector: 'app-ventas-off-white',
  templateUrl: './ventas-off-white.component.html',
  styleUrls: ['./ventas-off-white.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule]
})
export class VentasOffWhiteComponent {
  productoActual: Producto = {
    id: 3, // le cambié el id para que sea diferente
    nombre: 'Off-White',
    precio: 200000,
