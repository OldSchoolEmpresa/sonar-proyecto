  ...
  <script>
    ...
    window.addEventListener('load', () => {
      ...
      <div class="row">
        <?php
        include_once __DIR__ . '/../modelo/modelo.php';
        $modelo = new Modelo();
    ...
    <script>
      document.getElementById("agregarUsuarioForm").addEventListener("submit", function(e) {
        ...
        xhr.open("POST", "http://52.225.87.160/agregar", true);
      ...
      function editarUsuario(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "http://52.225.87.160/editar", true);
      ...
      function eliminarUsuario(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "http://52.225.87.160/eliminar", true);
            xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xhr.onreadystatechange = function () {
              if (xhr.readyState === 4 && xhr.status === 200) {
                Swal.fire({
